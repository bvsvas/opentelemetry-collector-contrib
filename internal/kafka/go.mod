...
require (
	...
	go.opentelemetry.io/collector/config/configcompression v1.37.1-0.20250801020258-8b73477b9810
...
require (
	...
	go.opentelemetry.io/collector/confmap v1.37.1-0.20250801020258-8b73477b9810 // indirect
